...
try:
    while True:
        ...
        print("Tag data:", tag_data)  # Tambahkan pernyataan ini untuk melacak data tag RFID yang diterima
        ...
        if last_speed > 0:
            ...
            GPIO.output(IN3, GPIO.HIGH)
            GPIO.output(IN4, GPIO.LOW)
            # Change duration of sleep based on the last detected speed
            time.sleep(0.1 + last_speed / 100.0)
        else:
